...
class _Dot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      width: (slideShowModel.currentPage == index) ? slideShowModel.bulletPrimario : slideShowModel.bulletSecundario,
      height: (slideShowModel.currentPage == index) ?  slideShowModel.bulletPrimario : slideShowModel.bulletSecundario,
  ...
  Widget build(BuildContext context) {
    return Container(
      child: PageView(
        ...
        children: widget.slides.map((slide) => _Slide(
          slide: slide
        )).toList(),
      ),
    );
